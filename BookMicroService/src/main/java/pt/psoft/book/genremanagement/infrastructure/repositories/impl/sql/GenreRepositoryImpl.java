package pt.psoft.book.genremanagement.infrastructure.repositories.impl.sql;
...
import pt.psoft.book.bookmanagement.model.sql.BookSqlEntity;
import pt.psoft.book.bookmanagement.services.GenreBookCountDTO;
import pt.psoft.book.genremanagement.infrastructure.repositories.impl.mappers.GenreEntityMapper;
import pt.psoft.book.genremanagement.infrastructure.repositories.impl.redis.GenreRepositoryRedisImpl;
import pt.psoft.book.genremanagement.model.Genre;
import pt.psoft.book.genremanagement.model.sql.GenreSqlEntity;
import pt.psoft.book.genremanagement.repositories.GenreRepository;
import pt.psoft.book.genremanagement.services.GenreLendingsDTO;
import pt.psoft.book.genremanagement.services.GenreLendingsPerMonthDTO;
...
public class GenreRepositoryImpl implements GenreRepository {
    ...
    public List<GenreLendingsPerMonthDTO> getLendingsPerMonthLastYearByGenre() {
        ...
        Join<LendingSqlEntity, BookSqlEntity> bookJoin = lendingRoot.join("book");
        Join<BookSqlEntity, GenreSqlEntity> genreJoin = bookJoin.join("genre");
    ...
    public List<GenreLendingsDTO> getAverageLendingsInMonth(LocalDate month, pt.psoft.g1.psoftg1.shared.services.Page page) {
        ...
        Root<LendingSqlEntity> lendingRoot = cq.from(LendingSqlEntity.class);
        Join<LendingSqlEntity, BookSqlEntity> bookJoin = lendingRoot.join("book", JoinType.LEFT);
        Join<BookSqlEntity, GenreSqlEntity> genreJoin = bookJoin.join("genre", JoinType.LEFT);
